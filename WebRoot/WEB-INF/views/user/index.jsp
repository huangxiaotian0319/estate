...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="#">小区物业管理系统</a>
...
<dd style="display: block;"> 
 ...
 <li>
  ...
  <a   href="javascript:void(0)" data-href="${pageContext.request.contextPath}/user/user_info/detail" data-title="我的信息" title="我的信息"> 
我的信息 
</a>
...
<dd style="display: block;"> 
 ...
 <li>
  ...
  <a   href="javascript:void(0)" data-href="${pageContext.request.contextPath}/user/car_user_info" data-title="我的车位" title="我的车位"> 
我的车位 
</a>
...
<dd style="display: block;"> 
 ...
 <li>
  ...
  <a   href="javascript:void(0)" data-href="${pageContext.request.contextPath}/user/complain_info" data-title="我的投诉" title="我的投诉"> 
我的投诉 
</a>
...
<dd style="display: block;"> 
 ...
 <li>
  ...
  <a   href="javascript:void(0)" data-href="${pageContext.request.contextPath}/user/fee_log" data-title="我的费用单" title="我的费用单"> 
我的费用单 
</a>
...
<dd style="display: block;"> 
 ...
 <li>
  ...
  <a   href="javascript:void(0)" data-href="${pageContext.request.contextPath}/user/news_info" data-title="新闻" title="新闻"> 
新闻 
</a>
...
<dd style="display: block;"> 
 ...
 <li>
  ...
  <a   href="javascript:void(0)" data-href="${pageContext.request.contextPath}/user/notice_info" data-title="系统公告" title="系统公告"> 
系统公告 
</a>
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="我的信息" data-href="${pageContext.request.contextPath}/user/user_info/detail">我的信息</span>
					<em></em></li>
		</ul>
	</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" id="iframeDom" frameborder="0" src="${pageContext.request.contextPath}/user/user_info/detail"></iframe>
	</div>
</div>
</section>
