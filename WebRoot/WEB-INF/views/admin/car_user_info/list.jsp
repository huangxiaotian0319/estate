                        ...
                        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/hui/static/h-ui.admin/skin/green/skin.css" id="skin" />
                            <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/hui/static/h-ui.admin/css/style.css" />
                                ...
                                <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/common/page/myPagination.css?t=4" />
                                    ...
                                    <nav class="breadcrumb"><i class="Hui-iconfont"></i>车位分配<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont"></i></a></nav>
                                    ...
                                    <c:forEach items="${usedStatusList}" var="item">
                                        <option value="${item.id}">${item.name}</option>
                                            ...
                                            <a href="${pageContext.request.contextPath}/admin/car_user_info/add?carId=${data.carId}" class="btn btn-success radius">分配车位</a>
                                                            ...
                                                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/hui/static/h-ui/js/H-ui.min.js"></script>
                                                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/hui/static/h-ui.admin/js/H-ui.admin.js"></script> <!--/_footer 作为公共模版分离出去-->
                                                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/hui/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
                                                                        ...
                                                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=5223"></script>
                                                                            ...
                                                                            function ajaxList(page) {
                                                                                ...
                                                                                showLoading('${pageContext.request.contextPath}/static/common/loading.gif');
                                                                                    $.ajax({
                                                                                        type : 'get',
                                                                                        url : "${pageContext.request.contextPath}/admin/car_user_info/queryList",
                                                                                            data : {
                                                                                                "page":page,
                                                                                                ...
                                                                                                success : function(result) {
                                                                                                    ...
                                                                                                    for (var i = 0; i < rows.length; i++) {
                                                                                                        ...
                                                                                                        html+='<td>';
                                                                                                        if(rows[i].carUserInfo.usedStatus=='1'){
                                                                                                            html+='<a href="javascript:void(0)" onclick="updateByDefault(this)" data-id="'+rows[i].carUserInfo.id+'" act-type="1" class="btn btn-warning radius btnStyle">结束使用</a>';
                                                                                                        }
                                                                                                        html+='</td>';
                                                                                                        html+='</tr>';
                                                                                                    }
                                                                                        ...
                                                                                        function updateByDefault(e){
                                                                                            ...
                                                                                            if(r==true){
                                                                                                ...
                                                                                                $.ajax({
                                                                                                    type : 'get',
                                                                                                    url : "${pageContext.request.contextPath}/admin/car_user_info/updateByDefault",
                                                                                                        data : {
                                                                                                            "id":id
                                                                                                        },
                                                                                                        success : function(result) {
